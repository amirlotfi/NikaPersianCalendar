package ir.nikatech.persiancalendar.util;
...
import ir.nikatech.persiancalendar.adapter.ShapedArrayAdapter;
import ir.nikatech.persiancalendar.entity.CityEntity;
import ir.nikatech.persiancalendar.entity.DayEntity;
import ir.nikatech.persiancalendar.entity.EventEntity;
import ir.nikatech.persiancalendar.enums.CalendarTypeEnum;
import ir.nikatech.persiancalendar.enums.SeasonEnum;
import ir.nikatech.persiancalendar.service.BroadcastReceivers;

import static ir.nikatech.persiancalendar.Constants.AM_IN_PERSIAN;
import static ir.nikatech.persiancalendar.Constants.ARABIC_DIGITS;
import static ir.nikatech.persiancalendar.Constants.BROADCAST_ALARM;
import static ir.nikatech.persiancalendar.Constants.BROADCAST_RESTART_APP;
import static ir.nikatech.persiancalendar.Constants.DARK_THEME;
import static ir.nikatech.persiancalendar.Constants.DAYS_ICONS;
import static ir.nikatech.persiancalendar.Constants.DAYS_ICONS_FA;
import static ir.nikatech.persiancalendar.Constants.DEFAULT_ALTITUDE;
import static ir.nikatech.persiancalendar.Constants.DEFAULT_APP_LANGUAGE;
import static ir.nikatech.persiancalendar.Constants.DEFAULT_ATHAN_VOLUME;
import static ir.nikatech.persiancalendar.Constants.DEFAULT_CITY;
import static ir.nikatech.persiancalendar.Constants.DEFAULT_IRAN_TIME;
import static ir.nikatech.persiancalendar.Constants.DEFAULT_ISLAMIC_OFFSET;
import static ir.nikatech.persiancalendar.Constants.DEFAULT_LATITUDE;
import static ir.nikatech.persiancalendar.Constants.DEFAULT_LONGITUDE;
import static ir.nikatech.persiancalendar.Constants.DEFAULT_NOTIFY_DATE;
import static ir.nikatech.persiancalendar.Constants.DEFAULT_PERSIAN_DIGITS;
import static ir.nikatech.persiancalendar.Constants.DEFAULT_PRAY_TIME_METHOD;
import static ir.nikatech.persiancalendar.Constants.DEFAULT_SELECTED_WIDGET_TEXT_COLOR;
import static ir.nikatech.persiancalendar.Constants.DEFAULT_WIDGET_CLOCK;
import static ir.nikatech.persiancalendar.Constants.DEFAULT_WIDGET_IN_24;
import static ir.nikatech.persiancalendar.Constants.FONT_PATH;
import static ir.nikatech.persiancalendar.Constants.KEY_EXTRA_PRAYER_KEY;
import static ir.nikatech.persiancalendar.Constants.LIGHT_THEME;
import static ir.nikatech.persiancalendar.Constants.PERSIAN_COMMA;
import static ir.nikatech.persiancalendar.Constants.PERSIAN_DIGITS;
import static ir.nikatech.persiancalendar.Constants.PM_IN_PERSIAN;
import static ir.nikatech.persiancalendar.Constants.PREF_ALTITUDE;
import static ir.nikatech.persiancalendar.Constants.PREF_APP_LANGUAGE;
import static ir.nikatech.persiancalendar.Constants.PREF_ATHAN_ALARM;
import static ir.nikatech.persiancalendar.Constants.PREF_ATHAN_GAP;
import static ir.nikatech.persiancalendar.Constants.PREF_ATHAN_VOLUME;
import static ir.nikatech.persiancalendar.Constants.PREF_GEOCODED_CITYNAME;
import static ir.nikatech.persiancalendar.Constants.PREF_IRAN_TIME;
import static ir.nikatech.persiancalendar.Constants.PREF_ISLAMIC_OFFSET;
import static ir.nikatech.persiancalendar.Constants.PREF_LATITUDE;
import static ir.nikatech.persiancalendar.Constants.PREF_LONGITUDE;
import static ir.nikatech.persiancalendar.Constants.PREF_NOTIFY_DATE;
import static ir.nikatech.persiancalendar.Constants.PREF_PERSIAN_DIGITS;
import static ir.nikatech.persiancalendar.Constants.PREF_PRAY_TIME_METHOD;
import static ir.nikatech.persiancalendar.Constants.PREF_SELECTED_LOCATION;
import static ir.nikatech.persiancalendar.Constants.PREF_SELECTED_WIDGET_TEXT_COLOR;
import static ir.nikatech.persiancalendar.Constants.PREF_THEME;
import static ir.nikatech.persiancalendar.Constants.PREF_WIDGET_CLOCK;
import static ir.nikatech.persiancalendar.Constants.PREF_WIDGET_IN_24;
...
public class Utils {
    ...
    public String dateToString(AbstractDate date) {
        return formatNumber(date.getDayOfMonth()) + ' ' + getMonthName(date) + ' ' + formatNumber(date.getYear());
    }
    ...
    public int getDayIconResource(int day) {
        try {
            return preferredDigits == ARABIC_DIGITS ? DAYS_ICONS[day] : DAYS_ICONS_FA[day];
    ...
    public Uri getAthanUri() {
        ...
        boolean athan_mode = prefs.getBoolean("Athan_mode", true);
        if (athan_mode) {
            defaultSoundUri = "android.resource://" + context.getPackageName() + "/" + R.raw.athan;
        } else if (!athan_mode) {
            defaultSoundUri = "android.resource://" + context.getPackageName() + "/" + R.raw.allah;
        }
    ...
    public int fillYearMonthDaySpinners(Context context, Spinner calendarTypeSpinner, Spinner yearSpinner, Spinner monthSpinner, Spinner daySpinner) {
        AbstractDate date;
