...
import ir.nikatech.persiancalendar.adapter.CalendarAdapter;
import ir.nikatech.persiancalendar.util.Utils;
import ir.nikatech.persiancalendar.view.dialog.SelectDayDialog;
...
public class CalendarFragment extends Fragment implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tapsellBannerView = (TapsellBannerView) view.findViewById(R.id.tapsell_banner);
        tapsellBannerView.loadAd(view.getContext(), "5c597ec05aac2f0001d2e2c8", TapsellBannerType.BANNER_320x50);
        ...
        tapsellBannerView.setEventListener(new TapsellBannerViewEventListener() {
            ...
            public void onRequestFilled() {
                tapsellBannerView.setVisibility(View.VISIBLE);
            }
